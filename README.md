...
Form Validation is the behind the scenes code that makes it so that you cant submit data that doesnt meet a certain requirement - for example alot of places will have a 'strength of password' validation - if you dont create a password that meets a certain criteria, say, have a number and a symbol in it. The form will not let you move on. 
